...
namespace Nop.Web.Framework.UI
{
	public partial class PageHeadBuilder : IPageHeadBuilder
	{
		...
		public virtual string GenerateMetaDescription()
		{
			...
			return String.IsNullOrEmpty(metaDescription) ? _seoSettings.DefaultMetaDescription : metaDescription;
		}
		...
		public virtual string GenerateMetaKeywords()
		{
			...
			return String.IsNullOrEmpty(metaKeyword) ? _seoSettings.DefaultMetaDescription : metaKeyword;
		}
