...
namespace Nop.Services.Security
{
	public partial class StandardPermissionProvider : IPermissionProvider
	{
		...
		public static readonly PermissionRecord ViewFreelist = new PermissionRecord { Name = "Public store. View freelist", SystemName = "ViewFreelist", Category = "PublicStore" };
