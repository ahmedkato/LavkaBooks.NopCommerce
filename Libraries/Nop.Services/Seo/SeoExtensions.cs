		...
		private static void InitializeSeoCharacterTable()
		{
			lock (s_lock)
			{
				if (_seoCharacterTable == null)
				{
					...
					_seoCharacterTable.Add(ToUnichar("0410"), "A");	// CYRILLIC CAPITAL LETTER A
					_seoCharacterTable.Add(ToUnichar("0411"), "B");	// CYRILLIC CAPITAL LETTER BE
					_seoCharacterTable.Add(ToUnichar("0412"), "V");	// CYRILLIC CAPITAL LETTER VE
					_seoCharacterTable.Add(ToUnichar("0413"), "G");	// CYRILLIC CAPITAL LETTER GHE
					_seoCharacterTable.Add(ToUnichar("0414"), "D");	// CYRILLIC CAPITAL LETTER DE
					_seoCharacterTable.Add(ToUnichar("0415"), "E");	// CYRILLIC CAPITAL LETTER IE
					_seoCharacterTable.Add(ToUnichar("0416"), "Zh");// CYRILLIC CAPITAL LETTER ZHE
					_seoCharacterTable.Add(ToUnichar("0417"), "Z");	// CYRILLIC CAPITAL LETTER ZE
					_seoCharacterTable.Add(ToUnichar("0418"), "I");	// CYRILLIC CAPITAL LETTER I
					_seoCharacterTable.Add(ToUnichar("0419"), "Y");	// CYRILLIC CAPITAL LETTER SHORT I
					_seoCharacterTable.Add(ToUnichar("041A"), "K");	// CYRILLIC CAPITAL LETTER KA
					_seoCharacterTable.Add(ToUnichar("041B"), "L");	// CYRILLIC CAPITAL LETTER EL
					_seoCharacterTable.Add(ToUnichar("041C"), "M");	// CYRILLIC CAPITAL LETTER EM
					_seoCharacterTable.Add(ToUnichar("041D"), "N");	// CYRILLIC CAPITAL LETTER EN
					_seoCharacterTable.Add(ToUnichar("041E"), "O");	// CYRILLIC CAPITAL LETTER O
					_seoCharacterTable.Add(ToUnichar("041F"), "P");	// CYRILLIC CAPITAL LETTER PE
					_seoCharacterTable.Add(ToUnichar("0420"), "R");	// CYRILLIC CAPITAL LETTER ER
					_seoCharacterTable.Add(ToUnichar("0421"), "S");	// CYRILLIC CAPITAL LETTER ES
					_seoCharacterTable.Add(ToUnichar("0422"), "T");	// CYRILLIC CAPITAL LETTER TE
					_seoCharacterTable.Add(ToUnichar("0423"), "U");	// CYRILLIC CAPITAL LETTER U
					_seoCharacterTable.Add(ToUnichar("0424"), "F");	// CYRILLIC CAPITAL LETTER EF
					_seoCharacterTable.Add(ToUnichar("0425"), "Kh");// CYRILLIC CAPITAL LETTER HA
					_seoCharacterTable.Add(ToUnichar("0426"), "Ts");// CYRILLIC CAPITAL LETTER TSE
					...
					_seoCharacterTable.Add(ToUnichar("0401"), "Yo");// CYRILLIC CAPITAL LETTER IO
					_seoCharacterTable.Add(ToUnichar("0430"), "a");	// CYRILLIC SMALL LETTER A
					...
					_seoCharacterTable.Add(ToUnichar("0438"), "i");	// CYRILLIC SMALL LETTER I
					_seoCharacterTable.Add(ToUnichar("0439"), "y");	// CYRILLIC SMALL LETTER SHORT I
					_seoCharacterTable.Add(ToUnichar("043A"), "k");	// CYRILLIC SMALL LETTER KA
					_seoCharacterTable.Add(ToUnichar("043B"), "l");	// CYRILLIC SMALL LETTER EL
					_seoCharacterTable.Add(ToUnichar("043C"), "m");	// CYRILLIC SMALL LETTER EM
					_seoCharacterTable.Add(ToUnichar("043D"), "n");	// CYRILLIC SMALL LETTER EN
					_seoCharacterTable.Add(ToUnichar("043E"), "o");	// CYRILLIC SMALL LETTER O
					_seoCharacterTable.Add(ToUnichar("043F"), "p");	// CYRILLIC SMALL LETTER PE
					_seoCharacterTable.Add(ToUnichar("0440"), "r");	// CYRILLIC SMALL LETTER ER
					_seoCharacterTable.Add(ToUnichar("0441"), "s");	// CYRILLIC SMALL LETTER ES
					_seoCharacterTable.Add(ToUnichar("0442"), "t");	// CYRILLIC SMALL LETTER TE
					_seoCharacterTable.Add(ToUnichar("0443"), "u");	// CYRILLIC SMALL LETTER U
					_seoCharacterTable.Add(ToUnichar("0444"), "f");	// CYRILLIC SMALL LETTER EF
					_seoCharacterTable.Add(ToUnichar("0445"), "h");	// CYRILLIC SMALL LETTER HA
					_seoCharacterTable.Add(ToUnichar("0446"), "ts");// CYRILLIC SMALL LETTER TSE
